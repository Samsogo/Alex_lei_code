...
<title>ECharts 可视化分析淘宝近几个月的交易量</title>
<link href="./css/style.css" type='text/css' rel="stylesheet"/>
<script src="./js/echarts.min.js"></script>
</head>
<body>
	<div class='header'>
        <p>ECharts 可视化分析淘宝近几个月的交易量</p>
    </div>
    <div class="content">
        <div class="nav">
            <ul>
                ...
                <li class="current"><a href="#">各月份的总成交量对比</a></li>
            </ul>
        </div>
        <div class="container">
            <div class="title">各省份的总成交量对比</div>
            <div class="show">
                <div class='chart-type'>直方图</div>
                <div id="main"></div>
            </div>
        </div>
    </div>
